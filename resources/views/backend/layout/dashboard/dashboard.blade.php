                    ...
                    <div class="col mb-5">
                        <div class="card h-100 card-lift">
                            <div class="card-body">
                                ...
                                <a href="{{ route('quizzes.index') }}" class="btn-link fw-semi-bold">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100 card-lift">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="text-muted fw-semi-bold ">Questions</span>
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="35" height="35" x="0"
                                            y="0" viewBox="0 0 500 500" style="enable-background:new 0 0 512 512"
                                ...
                                <a href="{{ route('questions.index') }}" class="btn-link fw-semi-bold">View</a>
                            </div>
                        </div>
                    </div>
                    {{-- <div class="col mb-5">
